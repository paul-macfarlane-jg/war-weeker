...
| What this repository is for | War Weeker: one place for Jahnel Group organizers to run War Week (themes, schedule, teams, competitions, points, awards, announcements) and for participants to follow it, plus a curated War Week history. Built for the JG AI Connection Event; submission due Fri 2026-09-25 10:00 AM. |
