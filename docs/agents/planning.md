...
| discovered repository fact | MCP tool change | /api/mcp stays read-only and requires a signed-in @jahnelgroup.com session (ticket 08 scope change); never expose hidden standings. |
